        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-base md:text-lg text-primary-dark/70 mb-12 max-w-2xl mx-auto leading-relaxed font-light">
              Creamos experiencias únicas y memorables para tus celebraciones más especiales en Querétaro. 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-primary-dark/70 leading-relaxed mb-6">
                En Doblando el Viento, entendemos que cada celebración es única. Con más de 5 años 
                de experiencia en la curaduría de eventos en Querétaro, nos especializamos en crear 
